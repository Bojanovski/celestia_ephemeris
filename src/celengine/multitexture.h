...
public:
    ...
    void setTexture(const fs::path& source, const fs::path& path, unsigned int flags = 0)
    {
        //throw;
    }
    void setTexture(const fs::path& source, const fs::path& path, float bumpHeight, unsigned int flags)
    {
        //throw;
    }
    ...
    bool isValid() const { throw; return false; }
